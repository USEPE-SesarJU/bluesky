...
class Traffic( Entity ):
    ...
    def update( self ):
        ...
        #---------- Fly the Aircraft --------------------------
        # autopilot_update = 10  # dt of update for the autopilot
        # if bs.sim.simt % autopilot_update == 0:
    ...
    def update_groundspeed( self ):
        ...
        if self.wind.winddim == 0:  # no wind
            ...
            applywind = self.alt > 0.*ft  # Only apply wind when airborne
